...
func TestWriteCrashDumpAtomicWrite(t *testing.T) {
	...
	tmpDir := t.TempDir()
	os.Setenv("ATOMIC_TEST_HOME", tmpDir)
	defer os.Unsetenv("ATOMIC_TEST_HOME")
...
func TestWriteCrashDumpCreatesDirectory(t *testing.T) {
	...
	tmpDir := t.TempDir()
	os.Setenv("MKDIR_TEST_HOME", tmpDir)
	defer os.Unsetenv("MKDIR_TEST_HOME")
...
func TestWriteCrashDumpEmptyFlightContext(t *testing.T) {
	tmpDir := t.TempDir()
	os.Setenv("EMPTY_FC_TEST_HOME", tmpDir)
	defer os.Unsetenv("EMPTY_FC_TEST_HOME")
...
func TestWriteCrashDumpLargeContextValues(t *testing.T) {
	tmpDir := t.TempDir()
	os.Setenv("LARGE_CTX_TEST_HOME", tmpDir)
	defer os.Unsetenv("LARGE_CTX_TEST_HOME")
...
func TestWriteCrashDumpFilenameFormat(t *testing.T) {
	tmpDir := t.TempDir()
	os.Setenv("FNNAME_TEST_HOME", tmpDir)
	defer os.Unsetenv("FNNAME_TEST_HOME")
