...
func TestSignalHandlerWritesCrashDumpOnSIGINT(t *testing.T) {
	tmpDir := t.TempDir()
	os.Setenv("SIGINT_TEST_HOME", tmpDir)
	defer os.Unsetenv("SIGINT_TEST_HOME")
...
func TestSignalHandlerSIGTERM(t *testing.T) {
	tmpDir := t.TempDir()
	os.Setenv("SIGTERM_TEST_HOME", tmpDir)
	defer os.Unsetenv("SIGTERM_TEST_HOME")
...
func TestSignalHandlerEmptyTraceID(t *testing.T) {
	tmpDir := t.TempDir()
	os.Setenv("SIG_EMPTR_TEST_HOME", tmpDir)
	defer os.Unsetenv("SIG_EMPTR_TEST_HOME")
...
func TestSignalHandlerWriteError(t *testing.T) {
	...
	os.Setenv("SIG_ERR_TEST_HOME", tmpFile)
	defer os.Unsetenv("SIG_ERR_TEST_HOME")
